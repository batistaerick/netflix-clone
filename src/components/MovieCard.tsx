...
export default function MovieCard({ data }: MovieCardProps) {
  ...
  return (
    <div className="group bg-zinc-900 col-span-1 relative h-[12vw]">
      <img
        className={`
          cursor-pointer object-cover transition shadow-xl rounded-md
      ...
      <div
        className={`
          opacity-0 absolute top-0 transition duration-200
      ...
      >
        <img
          className={`
            cursor-pointer object-cover transition shadow-xl rounded-t-md w-full h-[12vw]
          `}
          src={data.thumbnailUrl}
          alt="Thumbnail"
        />
        ...
        >
          ...
          <div className="flex flex-row items-center mt04 gap-2">
